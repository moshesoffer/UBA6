...
import {
  Popper_default
} from "./chunk-REG2JHI5.js";
import {
  ArrowDropDown_default,
  filledInputClasses_default,
  inputClasses_default
} from "./chunk-G4353HK3.js";
import {
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map((option, index) => {
        ...
        return (0, import_jsx_runtime2.jsx)(Chip_default, _extends({
