...
#define ADC1_VGEN_CH1_Pin GPIO_PIN_0
#define ADC1_VGEN_CH1_GPIO_Port GPIOF
...
#define UART2_DIR_Pin GPIO_PIN_1
#define UART2_DIR_GPIO_Port GPIOA
...
#define USRT1_DIR_Pin GPIO_PIN_12
#define USRT1_DIR_GPIO_Port GPIOA
...
#define F_CS_Pin GPIO_PIN_1
#define F_CS_GPIO_Port GPIOD
#define LCD_DC_Pin GPIO_PIN_2
#define LCD_DC_GPIO_Port GPIOD
#define SWO_Pin GPIO_PIN_3
#define SWO_GPIO_Port GPIOB
#define SH_SCL_Pin GPIO_PIN_4
#define SH_SCL_GPIO_Port GPIOB
