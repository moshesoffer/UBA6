...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : F_CS_Pin CHRG_EN_CH1_Pin */
  ...
  /*Configure GPIO pins : Negative_CH1_Pin DISP_CS_Pin BCLK_Pin */
  ...
  /*Configure GPIO pins : FAN_Pin DISCH_EN_CH1_Pin DISCH_EN_CH2_Pin PD1 */
  ...
  /*Configure GPIO pin : virtual_DE_Pin */
